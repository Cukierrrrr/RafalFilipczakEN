...
if(window.innerWidth <= 463){
    document.querySelector('#jezyk p').innerHTML = '<img src="img/wielkabrytania.png" alt="flag of UK"><img src="img/strzalka.png" alt="strzałka" id="strzalka">';
    document.querySelectorAll('#xdd ul li p')[0].innerHTML = '<img src="img/polska.png" alt="flag of poland">';
    ...
    document.querySelectorAll('#xdd ul li p')[1].innerHTML = '<img src="img/wielkabrytania.png" alt="flaga of UK">';
...
window.addEventListener("resize", function(){
    if(window.innerWidth <= 463){
        ...
        document.querySelectorAll('#xdd ul li')[0].style.textAlign = 'right';
        document.querySelectorAll('#xdd ul li p')[0].style.marginRight = '29px';
        document.querySelectorAll('#xdd ul li p')[1].innerHTML = '<img src="img/wielkabrytania.png" alt="flag of UK">';
        document.querySelectorAll('#xdd ul li')[1].style.textAlign = 'right';
        document.querySelectorAll('#xdd ul li p')[1].style.marginRight = '29px';
    }
    else{
        document.querySelector('#jezyk p').innerHTML = '<img src="img/wielkabrytania.png" alt="flag of UK">ENGLISH<img src="img/strzalka.png" alt="strzałka" id="strzalka">';
        document.querySelectorAll('#xdd ul li p')[0].innerHTML = '<img src="img/polska.png" alt="flag of Poland">POLSKI';
        document.querySelectorAll('#xdd ul li')[0].style.textAlign = 'left';
        document.querySelectorAll('#xdd ul li p')[0].style.marginRight = '0';
        document.querySelectorAll('#xdd ul li p')[1].innerHTML = '<img src="img/wielkabrytania.png" alt="flag of UK">ENGLISH';
